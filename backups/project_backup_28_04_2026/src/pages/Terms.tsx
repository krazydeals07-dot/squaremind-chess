  ...
  return (
    <StaticPageLayout title="Terms and Conditions">
      ...
      <Box component="ul" sx={{ pl: 2.5, my: 1, paddingLeft: '20px' }}>
        <Typography component="li" sx={{ mb: 0.5 }}>You must be 13 years of age or older to create an account. Users between the ages of 13 and 18 must use the App under the supervision of a parent or legal guardian.</Typography>
      ...
      <Typography variant="h6" component="h3" sx={{fontSize: '1.1rem', marginTop: '1rem'}}>Game of Skill Declaration</Typography>
      <Typography variant="body1" paragraph>
        Chess is globally and legally recognized as a &quot;Game of Skill.&quot; Success in the game depends primarily upon the superior knowledge, training, attention, experience, and adroitness of the player. As a game of skill, SquareMind tournaments are exempt from many gambling-related prohibitions under Indian law.
      </Typography>
      ...
      <Typography variant="h6" component="h3" sx={{fontSize: '1.1rem', marginTop: '1rem'}}>Fair Play &amp; Anti-Cheating Policy</Typography>
      <Box component="ul" sx={{ pl: 2.5, my: 1, paddingLeft: '20px' }}>
        <Typography component="li" sx={{ mb: 0.5 }}>The use of Chess Engines (e.g., Stockfish, Komodo), external software, or assistance from third parties is strictly prohibited.</Typography>
        <Typography component="li" sx={{ mb: 0.5 }}>We employ advanced detection methods to ensure fair play. If a user is suspected of cheating, SquareMind reserves the right to suspend the account immediately.</Typography>
        <Typography component="li">Confirmed cheating will result in a permanent ban, forfeiture of all prizes, and no refund of entry fees.</Typography>
      </Box>

      <Typography variant="h6" component="h3" sx={{fontSize: '1.1rem', marginTop: '1rem'}}>Prizes</Typography>
      <Box component="ul" sx={{ pl: 2.5, my: 1, paddingLeft: '20px' }}>
        <Typography component="li" sx={{ mb: 0.5 }}>SquareMind does not offer any cash-based prizes. NO CASH will be distributed under any circumstances.</Typography>
        <Typography component="li" sx={{ mb: 0.5 }}>All rewards are provided ONLY in the form of physical goods (e.g., bicycles, T-shirts, electronics) or digital gift cards (e.g., Amazon, Flipkart vouchers).</Typography>
